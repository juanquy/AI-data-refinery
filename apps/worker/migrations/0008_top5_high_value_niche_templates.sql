...
(
  ...
  'Extract affected symbols, deprecated function names, breaking signatures, and exact before/after code migration snippets.',
  1
),
(
  ...
  'Extract normalized monthly/annual pricing, seat minimums, included usage/token quotas, and hidden overage terms.',
  1
),
(
  ...
  'Extract municipal zoning classifications, short-term rental permit laws, mandatory compliance checklists, and penalty fine structures.',
  1
),
(
  ...
  'Extract active pharmaceutical ingredients, FDA approval status, clinical trial phases, black box warnings, and patent exclusivity expiration dates.',
  1
),
(
  ...
  'Extract GAAP vs Non-GAAP operating metrics, total debt maturities, forward guidance statements, and highlighted corporate risk factors from SEC filings.',
  1
);
